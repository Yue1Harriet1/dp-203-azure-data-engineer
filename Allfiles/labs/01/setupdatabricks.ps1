#References of az powershell for az databricks: https://learn.microsoft.com/en-us/powershell/module/az.databricks/?view=azps-9.2.0

Clear-Host
write-host "Starting script at $(Get-Date)"
Set-PSRepository -Name PSGallery -InstallationPolicy Trusted
Install-Module -Name Az.Databricks # the other one is for synapse by: Install-Module -Name Az.Synapse -Force
